...
import footerAdornment from '../../../assets/Footer Adornment.png'
...
const SocialMedia = [
  { name: 'facebook logo', img: facebook, link: 'https://web.facebook.com/Alfrosoft-Microsystems-101548112408909' },
